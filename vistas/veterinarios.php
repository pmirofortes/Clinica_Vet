        ...
        <table>
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href='../formularios/editar_usuario.php?dni_veterinario=" . $row['dni_veterinario'] . "'>Editar</a></td>";
                    echo "<td><a href='../procesos/delete/delete_veterinario.php?dni_veterinario=" . $row['dni_veterinario'] . "'>Eliminar</a></td>";
                    echo "</tr>";
                }
            } else {
